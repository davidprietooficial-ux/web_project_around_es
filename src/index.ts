...
const cardList: Section<CardData> = new Section<CardData>(
    {
        items: initialCards,
        renderer: (item) => {
...
btnEdit.addEventListener("click", () => {
    ...
    (document.querySelector(".popup__input_type_name") as HTMLInputElement)
        .value = data.name;
    (document.querySelector(
        ".popup__input_type_description",
    ) as HTMLInputElement).value = data.about;
